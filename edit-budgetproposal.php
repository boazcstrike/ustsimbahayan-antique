...
if ($days == 0) {
    ...
    if (days != null) {
        window.location = 'edit-budgetproposal.php?d=".$d."&days='+days;
    }
    </script>";
    }; 
...
if(isset($_POST['submitted'])){
   ...
   //$totalcom = $totalcom + ($ptotalcom + $mtotalcom + $ototalcom + $ottotalcom);
	...
	echo "<script type='text/javascript'>alert('SUCCESSFULLY EDITED PROGRAM FLOW AND BUDGET PROPOSAL'); window.location ='org-listproposal.php?d=$d';</script>";
...
<?php
                 echo "<form role='form' class='form-horizontal' method='post' action='edit-budgetproposal.php?d=".$d."&&days=".$days."' enctype='multipart/form-data'>
