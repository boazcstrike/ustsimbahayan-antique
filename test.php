                      ...
                      <div class="col-md-2"><h5 style="font-weight: bold">Date(s) and Venue(s) of Project Implementation</h5></div>
                        <div class="row" style="margin-left:4px">
                          <div class="col-md-3">
                            ...
                            <input class="form-control" id="date" name="date['.$x.']" onblur = "checkDate();" type="date" required="required" placeholder="mm/dd/yyyy" value="'.$date[$x].'"/>
                          </div>
                          <div class="col-md-7">
                            <label class="control-label" for="address">Address</label>
                            <input class="form-control" type="text" required="required" placeholder="Room No./Building Name/Street Address, Village or Barangay/City or Province" name="address['.$x.']" value="'.$address[$x].'"/>
                          </div>
                        </div>
          </div>
                  <div class="col-md-12">
                      ...
                      <div class="col-md-12 column">
                        <table class="table table-bordered table-hover" id="prog_flow">
                          ...
                          <tbody>
                            <tr id="ppf0">
                              <td>1</td>
                              <td><input type="text" name="starttime0['.$x.']" placeholder="Time" pattern="^(00|0[0-9]|1[012]):[0-5][0-9] ?((a|p)m|(A|P)M)$" class="form-control" value="'.$starttime0[$x].'"/></td>
                              <td><input type="text" name="endtime0['.$x.']" placeholder="Time" pattern="^(00|0[0-9]|1[012]):[0-5][0-9] ?((a|p)m|(A|P)M)$" class="form-control" value="'.$endtime0[$x].'"/></td>
                              <td><input type="text" name="description0['.$x.']"  placeholder="Description" class="form-control" value="'.$description0[$x].'"/></td>
                              <td><input type="text" name="person0['.$x.']" placeholder="Name of Person/Group" class="form-control" value="'.$person0[$x].'"/></td>
                            </tr>
                            <tr id="ppf1">
                              <td>2</td>
                              <td><input type="text" name="starttime1['.$x.']" pattern="^(00|0[0-9]|1[012]):[0-5][0-9] ?((a|p)m|(A|P)M)$" placeholder="Time" class="form-control" value="'.$starttime1[$x].'"/></td>
